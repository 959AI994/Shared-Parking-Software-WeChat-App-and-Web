/*
 ...
 Date: 07/01/2022 03:33:54
*/

CREATE database shared_park2;
use shared_park2;
...
CREATE TABLE `feed_back`  (
  ...
  `content` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '反馈内容',
...
CREATE TABLE `normaluser`  (
  ...
  `realName` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '真实姓名',
  ...
  `avatarUrl` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '头像',
  `role_id` int(11) NULL DEFAULT NULL COMMENT '角色编号',
  PRIMARY KEY (`openId`) USING BTREE,
  INDEX `fk_n_rid`(`role_id`) USING BTREE,
  CONSTRAINT `fk_n_rid` FOREIGN KEY (`role_id`) REFERENCES `sys_role` (`role_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `ownerauth`  (
  ...
  `imgUrl` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '证明图片路径',
  ...
  `notThroughReason` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '认证不通过原因',
  PRIMARY KEY (`ownerAuthId`) USING BTREE,
  INDEX `oforeuserid`(`openId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 65 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '业主信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ownerauth` VALUES (64, 'odxd_5ChhxfoLFkXHma4MIWlqqUo', '梁保锟', '0', '18377522951', '正常', '450881199901263833', '653251458755', 'http://localhost:8888/img/0df0e05a88e84e5682203c1587604a41.jpg', '玉林美林人家小区', 'G20', NULL);
...
CREATE TABLE `parking_order`  (
  ...
  `paymentAmount` float(40, 0) NULL DEFAULT NULL COMMENT '支付金额',
  ...
  `parkingDuration` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '停车时长',
...
-- ----------------------------
INSERT INTO `parking_order` VALUES ('120211126231208453791', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-11-26 23:12:08', '已完成', '2021-11-26 23:12:30', '2021-11-26 23:29:41', 1, '2021-12-19 10:50:18', '已支付', '52分钟');
INSERT INTO `parking_order` VALUES ('120211126232653665792', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-11-26 23:26:54', '已完成', '2021-11-26 23:32:42', '2021-11-27 14:19:19', 7, '2021-12-18 22:10:14', '已支付', '56分钟');
INSERT INTO `parking_order` VALUES ('120211211141725714797', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-10-11 14:17:26', '已完成', '2021-12-11 18:10:00', '2021-12-11 22:06:48', 89, '2021-12-18 22:14:50', '已支付', '3小时56分');
INSERT INTO `parking_order` VALUES ('120211211191317855793', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-12-11 19:13:18', '已完成', '2021-12-11 19:13:33', '2021-12-11 22:50:13', 29, '2021-12-18 22:14:12', '已支付', '3小时36分');
...
INSERT INTO `parking_order` VALUES ('120211212135649176797', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-06-01 13:56:49', '已完成', '2021-12-12 13:56:53', '2021-12-12 15:14:33', 63, '2021-12-24 10:51:27', '已支付', '1小时17分');
INSERT INTO `parking_order` VALUES ('120211212154205386797', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-05-13 15:42:05', '已完成', '2021-12-12 15:43:51', '2021-12-12 16:03:57', 56, '2021-12-12 16:05:30', '已支付', '20分钟');
INSERT INTO `parking_order` VALUES ('120211219110458389796', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-04-21 11:04:58', '已完成', '2021-12-19 11:12:31', '2021-12-19 11:12:46', 94, '2021-12-19 11:14:09', '已支付', '10分钟');
...
INSERT INTO `parking_order` VALUES ('120211219114159318797', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-02-01 11:41:59', '已完成', '2021-12-19 11:42:09', '2021-12-19 11:42:12', 90, '2021-12-19 11:49:22', '已支付', '10分钟');
INSERT INTO `parking_order` VALUES ('120211219114929698792', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-01-01 11:49:30', '已完成', '2021-12-19 11:49:33', '2021-12-19 11:49:35', 127, '2021-12-19 11:51:06', '已支付', '1分钟');
...
INSERT INTO `parking_order` VALUES ('120211219204121819795', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-03-01 20:41:22', '已完成', '2021-12-19 20:52:33', '2021-12-19 22:05:15', 10, '2021-12-19 22:53:44', '已支付', '1小时12分');
INSERT INTO `parking_order` VALUES ('120211219230826525792', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-03-01 23:08:27', '已完成', '2021-12-19 23:09:04', '2021-12-19 23:21:19', 2, '2021-12-19 23:21:52', '已支付', '12分钟');
INSERT INTO `parking_order` VALUES ('120211219232709021333', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-09-09 23:27:09', '已完成', '2021-12-19 23:27:18', '2021-12-19 23:27:50', 210, '2021-12-19 23:29:12', '已支付', '32秒');
INSERT INTO `parking_order` VALUES ('120211219232709021334', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-08-13 23:27:09', '已完成', '2021-12-19 23:27:18', '2021-12-19 23:27:50', 216, '2021-12-19 23:29:12', '已支付', '32秒');
...
INSERT INTO `parking_order` VALUES ('120211219232790213355', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-07-13 23:27:09', '已完成', '2021-12-19 23:27:18', '2021-12-19 23:27:50', 121, '2021-12-19 23:29:12', '已支付', '32秒');
...
INSERT INTO `parking_order` VALUES ('120211223174731272794', 'odxd_5NogANZ3cypwdeACNMiWWgU', 29, '2021-12-23 17:47:31', '进行中', '2021-12-23 17:47:52', '2021-12-23 18:15:38', 2, '2021-12-24 18:15:59', '已支付', '27分钟');
INSERT INTO `parking_order` VALUES ('120211223193026928796', 'odxd_5J4XEz8ZgZULdRwYtVkoq7I', 29, '2021-12-23 19:30:27', '进行中', '2021-12-23 19:31:30', '2021-12-31 19:33:33', 7, NULL, '未支付', '2小时');
...
INSERT INTO `parking_order` VALUES ('123211126231208453791', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-11-26 23:12:08', '已完成', '2021-11-26 23:12:30', '2021-11-26 23:29:41', 1, '2021-12-19 10:50:18', '已支付', '52分钟');
INSERT INTO `parking_order` VALUES ('123211126232653665792', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-11-26 23:26:54', '已完成', '2021-11-26 23:32:42', '2021-11-27 14:19:19', 7, '2021-12-18 22:10:14', '已支付', '56分钟');
INSERT INTO `parking_order` VALUES ('123211211141725714797', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-10-11 14:17:26', '已完成', '2021-12-11 18:10:00', '2021-12-11 22:06:48', 89, '2021-12-18 22:14:50', '已支付', '3小时56分');
INSERT INTO `parking_order` VALUES ('123211211191317855793', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-10-01 19:13:18', '已完成', '2021-12-11 19:13:33', '2021-12-11 22:50:13', 29, '2021-12-18 22:14:12', '已支付', '3小时36分');
...
INSERT INTO `parking_order` VALUES ('123211212135649176797', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-06-01 13:56:49', '已完成', '2021-12-12 13:56:53', '2021-12-12 15:14:33', 63, '2021-12-24 10:51:27', '已支付', '1小时17分');
INSERT INTO `parking_order` VALUES ('123211212154205386797', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-05-13 15:42:05', '已完成', '2021-12-12 15:43:51', '2021-12-12 16:03:57', 56, '2021-12-12 16:05:30', '已支付', '20分钟');
INSERT INTO `parking_order` VALUES ('123211219110458389796', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-04-21 11:04:58', '已完成', '2021-12-19 11:12:31', '2021-12-19 11:12:46', 94, '2021-12-19 11:14:09', '已支付', '10分钟');
...
INSERT INTO `parking_order` VALUES ('123211219114159318797', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-02-01 11:41:59', '已完成', '2021-12-19 11:42:09', '2021-12-19 11:42:12', 90, '2021-12-19 11:49:22', '已支付', '10分钟');
INSERT INTO `parking_order` VALUES ('123211219114929698792', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-01-01 11:49:30', '已完成', '2021-11-19 11:49:33', '2021-12-19 11:49:35', 127, '2021-12-19 11:51:06', '已支付', '1分钟');
...
INSERT INTO `parking_order` VALUES ('123211219204121819795', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-07-02 11:51:14', '已完成', '2021-12-19 20:52:33', '2021-12-19 22:05:15', 10, '2021-12-19 22:53:44', '已支付', '1小时12分');
INSERT INTO `parking_order` VALUES ('123211219230826525792', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-07-29 23:08:27', '已完成', '2021-12-19 23:09:04', '2021-12-19 23:21:19', 2, '2021-12-19 23:21:52', '已支付', '12分钟');
INSERT INTO `parking_order` VALUES ('123211219232709021333', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-09-09 23:27:09', '已完成', '2021-09-19 23:27:18', '2021-12-19 23:27:50', 210, '2021-12-19 23:29:12', '已支付', '32秒');
INSERT INTO `parking_order` VALUES ('123211219232709021334', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-08-13 23:27:09', '已完成', '2021-10-19 23:27:18', '2021-12-19 23:27:50', 216, '2021-12-19 23:29:12', '已支付', '32秒');
...
INSERT INTO `parking_order` VALUES ('123211219232790213355', 'odxd_5LQXXxgBk732-N16liGbTGs', 29, '2021-07-13 23:27:09', '已完成', '2021-09-19 23:27:18', '2021-12-19 23:27:50', 121, '2021-12-19 23:29:12', '已支付', '32秒');
...
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '车位表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of parkingspace
-- ----------------------------
INSERT INTO `parkingspace` VALUES (29, 'D20', 4, 56, '共享中', 0, 5.00, '2022-01-01 01:00:00', '2022-01-09 02:00:00');
INSERT INTO `parkingspace` VALUES (30, 'G102', 2, 57, '共享中', 0, 9.00, '2022-01-01 00:00:00', '2022-01-08 05:00:00');
INSERT INTO `parkingspace` VALUES (31, 'G11', 4, 58, '共享中', 0, 7.00, '2022-01-02 07:32:46', '2022-01-04 19:32:46');
INSERT INTO `parkingspace` VALUES (32, 'L66', 2, 59, '共享中', 0, 5.00, '2022-01-02 09:56:51', '2022-01-04 19:56:51');
INSERT INTO `parkingspace` VALUES (37, 'G20', 4, 64, '共享中', 0, 5.00, '2022-01-01 22:49:15', '2022-01-03 18:49:15');
...
CREATE TABLE `sys_menu`  (
  ...
  `path` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '菜单path',
...
CREATE TABLE `sys_role_menu`  (
  ...
  INDEX `fk_rm_rid`(`role_id`) USING BTREE,
  INDEX `fk_rm_mid`(`menu_id`) USING BTREE,
  CONSTRAINT `fk_rm_mid` FOREIGN KEY (`menu_id`) REFERENCES `sys_menu` (`menu_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_rm_rid` FOREIGN KEY (`role_id`) REFERENCES `sys_role` (`role_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `sys_user`  (
  ...
  `username` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户名',
...
CREATE TABLE `sys_user_role`  (
  ...
  `role_id` int(11) NULL DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_ur_uId`(`user_id`) USING BTREE,
  INDEX `fk_ur_rId`(`role_id`) USING BTREE,
  CONSTRAINT `fk_ur_rId` FOREIGN KEY (`role_id`) REFERENCES `sys_role` (`role_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_ur_uId` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
