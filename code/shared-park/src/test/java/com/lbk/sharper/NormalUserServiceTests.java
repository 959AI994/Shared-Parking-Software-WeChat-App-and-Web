...
import org.springframework.stereotype.Service;
    ...
    @Slf4j
    public class NormalUserServiceTests extends ServiceImpl<NormalUserMapper, NormalUser>{

        @Test
        public IPage<NormalUser> getPageListTests(UserVo userVo) {
        ...
        public NormalUser getUserInfoTests(String openId) {
        ...
        public NormalUser getUserTests(String openId) {
            if (openId == null) {
        ...
        public boolean userAuthTests(UserAuthFrom userAuthFrom, String openId) {
